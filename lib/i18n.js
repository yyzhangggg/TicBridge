...
const STRINGS = {
  ...
  autofillBtn: { zh: "预览自动填充", en: "Preview autofill", fr: "Aperçu du remplissage" },
  ...
  crossPlatformHint: {
    zh: "该操作只能在这个平台自己的发布页上使用 — 当前看到的面板运行在别的平台页面，这里只能查看/编辑排期",
    en: "This action only works on that platform's own publish page — the panel you're viewing is running on a different platform's page, so this tab is view/edit-only here",
    fr: "Cette action ne fonctionne que sur la page de publication propre à cette plateforme — le panneau que vous consultez s’exécute sur la page d’une autre plateforme, cet onglet n’est donc consultable/modifiable qu’ici"
  },

  preflightRunning: { zh: "正在检查页面字段…", en: "Checking page fields…", fr: "Vérification des champs de la page…" },
  preflightFailed: {
    zh: "检查发现问题，请先解决后再填充：",
    en: "Preflight found problems — resolve these before filling:",
    fr: "Le contrôle préalable a détecté des problèmes — à résoudre avant de remplir :"
  },
  preflightFieldLine: {
    zh: (field, reason) => `· ${field}：${reason}`,
    en: (field, reason) => `· ${field}: ${reason}`,
    fr: (field, reason) => `· ${field} : ${reason}`
  },
  preflightOk: {
    zh: "检查通过，请核对下方预览内容后再确认填充：",
    en: "Preflight passed. Review the preview below, then confirm to fill:",
    fr: "Contrôle réussi. Vérifiez l’aperçu ci-dessous, puis confirmez pour remplir :"
  },
  previewTitleLabel: { zh: "标题：", en: "Title: ", fr: "Titre : " },
  previewDescLabel: { zh: "简介：", en: "Description: ", fr: "Description : " },
  previewTagsLabel: { zh: "标签：", en: "Tags: ", fr: "Tags : " },
  confirmFillBtn: { zh: "确认填充", en: "Confirm fill", fr: "Confirmer le remplissage" },
  cancelFillBtn: { zh: "取消", en: "Cancel", fr: "Annuler" },
  fieldNameFileInput: { zh: "文件上传框", en: "File upload field", fr: "Champ de téléversement" },
  fieldNameTitle: { zh: "标题框", en: "Title field", fr: "Champ du titre" },
  fieldNameDescription: { zh: "简介框", en: "Description field", fr: "Champ de description" },
  fieldNameTagInput: { zh: "标签框", en: "Tags field", fr: "Champ des tags" },
  pageNotConnected: {
